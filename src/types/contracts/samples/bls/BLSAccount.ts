...
export interface BLSAccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addDeposit"
      | "aggregator"
...
export interface BLSAccount extends BaseContract {
  connect(runner?: ContractRunner | null): BLSAccount;
  ...
  setBlsPublicKey: TypedContractMethod<
    [newPublicKey: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "setBlsPublicKey"
  ): TypedContractMethod<
    [newPublicKey: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]],
    [void],
    "nonpayable"
