...
export interface CustomPaymasterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "conversionRateTokenToEth",
    values?: undefined
  ): string;
...
export interface CustomPaymaster extends BaseContract {
  connect(runner?: ContractRunner | null): CustomPaymaster;
  waitForDeployment(): Promise<this>;

  interface: CustomPaymasterInterface;
  ...
  conversionRateTokenToEth: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "conversionRateTokenToEth"
